...
class Triformer(nn.Module):
    def __init__(self, configs, num_nodes, input_dim, output_dim, channels, dynamic, lag,
                 horizon, patch_sizes, supports, mem_dim=5):
        ...
        for patch_size in patch_sizes:
            ...
            self.layers.append(Layer(device=configs.args.gpu, input_dim=channels,
        ...
        self.final = nn.Linear(num_nodes, configs.c_out)
    ...
    def forward(self, x, test=False):
        ...
        return self.final(self.projections(x).transpose(2, 1)).squeeze(-1)
