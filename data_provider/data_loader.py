...
class Dataset_Normal(Dataset):
    ...
    def __read_data__(self):
        ...
        for name, group in gb:
            ...
            feature = group.loc[:, ['open', 'close', 'high', 'low', 'volume', 'amount']].to_numpy()
            l, d = feature.shape
        ...
        if self.test:
            return np.stack(features, axis=0), np.stack(labels, axis=0), pd.concat(df_list)
